...
public class WeaponEditor : Editor
{
	...
	public override void OnInspectorGUI()
	{
		...
		//Extra stuff I custom made, finally found a work-around to my Weapon Inpsector issue
		showExtras = EditorGUILayout.Foldout(showExtras, "Extras");
		if (showExtras)
		{
			weapon.reference = (AmmoManager)EditorGUILayout.ObjectField("Reference", weapon.reference, typeof(AmmoManager), true);

			weapon.mask = (GasMask)EditorGUILayout.ObjectField("GasMask", weapon.mask, typeof(GasMask), true);
		}
