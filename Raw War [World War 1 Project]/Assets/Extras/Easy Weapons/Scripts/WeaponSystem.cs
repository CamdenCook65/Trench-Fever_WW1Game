...
public class WeaponSystem : MonoBehaviour
{
	...
	void Update()
	{
		...
		if (Input.GetButtonDown("Weapon 1"))
			SetActiveWeapon(1);
		if (Input.GetButtonDown("Weapon 2") && weapon.hasShotgun == true)
			SetActiveWeapon(2);
		if (Input.GetButtonDown("Weapon 3") && weapon.hasSMG == true)
			SetActiveWeapon(3);
		if (Input.GetButtonDown("Weapon 4") && weapon.hasLewis == true)
			SetActiveWeapon(4);
		if (Input.GetButtonDown("Weapon 5") && weapon.hasGrenade == true)
			SetActiveWeapon(5);
		if (Input.GetButtonDown("Weapon 6") && weapon.hasRocket == true)
			SetActiveWeapon(6);
		if (Input.GetButtonDown("Weapon 7") && weapon.hasFlamethrower == true)
			SetActiveWeapon(7);
